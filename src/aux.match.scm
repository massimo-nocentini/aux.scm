...
(module (aux match) *
  ...
  (define-syntax dmatch-ppat
    (syntax-rules (unquote _ __ let)
      ...
      ((dmatch-ppat vv () kt kf) (if (null? vv) kt kf))
      ((dmatch-ppat vv #() kt kf) (if (and (vector? vv) (zero? (vector-length vv))) kt kf))
