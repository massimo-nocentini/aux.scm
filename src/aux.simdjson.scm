  ...
  (define (simdjson->scheme w)
    (let1 (t (simdjson-get-type w))
      (cond
        ...
        ((simdjson-array? t) (simdjson-get-array w simdjson->scheme #;(λ (res i w*) (vector-set! res i (simdjson->scheme w*)) res)))
        ((simdjson-object? t) (vector->list (simdjson-get-object w (λ (k w*) (list k (simdjson->scheme w*))) #;(λ (res i k w*) (vector-set! res i (list (string->symbol k) (simdjson->scheme w*))) res))))
