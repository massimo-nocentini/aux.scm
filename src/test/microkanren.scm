...
(define-suite microkanren-suite
  ...
  ((test/find _)
   (let* ((v1 (make-µkanren-var 0))
          ...
          (s1 (make-µkanren-state (cons/sbral 'a (µkanren-state-S s0)) empty/sbral empty/sbral empty/sbral))
          (s2 (make-µkanren-state (cons/sbral v1 (µkanren-state-S s1)) empty/sbral empty/sbral empty/sbral)))
