  ...
  ((test/asai-pwl-talk/anf _)
    ...
    (define (anf/let expr w)
      (letrec ((count 0)
               (L (λ (e)
                    (match/first e
                      ((λ (,v) . ,d) `(λ (,v) . ,(map (λ (e) (resetcc (L e))) d)))
                      ((,a . ,d) (letcc/shift k 
                                  (let ((w (symbol-append w (string->symbol (number->string count))))
                                        (_ (add1! count))
                                        (a* (L a))
                                        (d* (map L d)))
                                    `(let1 (,w (,a* . ,d*)) ,(k w)))))
    ...
    (⊦= '(let1 (α1 (- b c d)) (let1 (α0 (- a α1)) α0)) (anf/let '(- a (- b c d)) 'α))
    (⊦= '((λ (α1) ((λ (α0) α0) (- a α1))) (- b c d)) (anf/λ '(- a (- b c d)) 'α))
    (⊦= '((λ (α2) ((λ (α1) ((λ (α0) α0) (- a α1))) (+ b α2))) (/ c d)) (anf/λ '(- a (+ b (/ c d))) 'α))
    (⊦= '((λ (α1) ((λ (α2) ((λ (α0) α0) (if α1 0 α2))) (void))) (null? l)) (anf/λ '(if (null? l) 0 (void)) 'α))
    (⊦= '((λ (α1)
              ((λ (α4)
                    ((λ (α3)
                        ((λ (α5)
    ...
    (⊦= '(λ (x) (λ (y) (λ (z) (let1 (α1 (x z)) (let1 (α2 (y z)) (let1 (α0 (α1 α2)) α0))))))
        (anf/let '(λ (x) (λ (y) (λ (z) ((x z) (y z))))) 'α))
    (⊦= '(λ (x) (λ (y) (λ (z) ((λ (α1) ((λ (α2) ((λ (α0) α0) (α1 α2))) (y z))) (x z)))))
